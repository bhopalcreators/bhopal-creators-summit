import { stats2026 as fallbackStats2026 } from '../data/siteContent';
import useApiContent from '../hooks/useApiContent';

export default function Stats2026() {
  const { data: stats } = useApiContent('/stats2026', fallbackStats2026);
